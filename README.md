...
4. **Integrasi Sistem Laci:** Data pengajuan anggota akan dikirim secara otomatis ke sistem **Laci** via REST API untuk diverifikasi oleh pengurus yang berwenang. Status verifikasi akan disinkronkan secara otomatis (real-time) melalui sistem Webhook.
